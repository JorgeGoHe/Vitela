...
pub(crate) fn despachar(cmd: &str, body: Value) -> Result<Value, String> {
    ...
    match cmd {
        ...
        "search_pdf" => cmd!(busqueda::search_pdf, { path: String, query: String }),
        ...
        "extract_pages" => cmd!(paginas::extract_pages, { work_path: String, page_indices: Vec<u16>, dest_path: String }),
        "save_pdf" => cmd!(crate::save_pdf, { work_path: String, dest_path: String }),
        "add_highlight" => cmd!(anotaciones::add_highlight, { work_path: String, page_index: u16, rects: Vec<crate::Rect> }),
        "add_stroke" => cmd!(anotaciones::add_stroke, { work_path: String, page_index: u16, points: Vec<[f32; 2]>, color: Option<[u8; 4]>, width: Option<f32> }),
        "add_note" => cmd!(anotaciones::add_note, { work_path: String, page_index: u16, x: f32, y: f32, text: String }),
